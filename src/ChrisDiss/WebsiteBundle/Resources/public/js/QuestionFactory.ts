...
class QuestionFactory
{
    ...
    public static getStroopQuestion() {
        var headsOrTails = Math.ceil(Math.random() * 2),
            colourForBox = ColourFactory.getRandomColour(),
            nameColour = ColourFactory.getRandomColourButNot([colourForBox]),
            thirdColour = ColourFactory.getRandomColourButNot([colourForBox, nameColour]);
    ...
    public static getRegularQuestion() {
        var headsOrTails = Math.ceil(Math.random() * 2),
            colourForBox = ColourFactory.getRandomColour(),
            differentColour = ColourFactory.getRandomColourButNot([colourForBox]);
